      ...
      <div className='container px-4 mx-auto'>
        <div className='relative xl:pb-52 text-center overflow-hidden'>
          ...
          <div className='relative'>
            <span className='inline-block py-3 px-7 mb-10 text-lg font-medium font-heading leading-5 text-indigo-500 border border-indigo-500 rounded-6xl'>Login</span>
            ...
            <div className='max-w-md mx-auto'>
              <input className='w-full mb-6 py-5 px-12 text-xl border-2 border-blue-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50' onChange={(e) => onChange(e)} name='mail' value={mail} type='email' placeholder='Your Email' />
              <input className='w-full mb-6 py-5 px-12 text-xl border-2 border-blue-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50' name='password' value={password} onChange={(e) => onChange(e)} type='password' placeholder='Password' />
              <div className='relative mb-14 flex justify-center items-center'>
                <a className='inline-block mr-4 -mt-5' href='#'>
                  <img src='uinel-assets/images/sign-up/check.svg' alt='' />
                </a>
                <input style={{ appearance: "none" }} type='checkbox' />
                <p className='text-gray-200'>
                  Nie masz konta <Link href='/Register'>Załóż</Link>
                </p>
              </div>
              <a className='block py-5 px-10 mx-auto w-full md:max-w-max text-xl leading-6 text-white font-medium tracking-tighter font-heading bg-blue-500 hover:bg-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-xl' onClick={onSubmitForm} href=''>
                Login
              </a>
            </div>
          </div>
