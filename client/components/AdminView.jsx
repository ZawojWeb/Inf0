...
const AdminView = ({ groupId, userId, privilage }) => {
  ...
  const components = [<ChatComponent groupId={groupId} />, <TasksComponent adminId={userId} userList={userList} groupId={groupId} userPrivilage={privilage} />, <ApisForm groupId={groupId} />]
  return (
